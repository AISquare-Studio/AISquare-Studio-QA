...
class CommentBuilder:
    ...
    def __init__(self, target_repo: str = None, pr_number: str = None, 
    ...
    def build_comment_body(self, generation_result: Dict[str, Any],
                          execution_result: Dict[str, Any],
                          suite_results: Dict[str, Any],
                          test_file_path: str,
                          screenshot_sections: Dict[str, str] = None) -> str:
        """
        ...
        # Build sections
        steps_section = self.build_steps_section(generation_result.get('metadata', {}).get('steps', []))
...
{steps_list}"""
    ...
    def build_results_section(self, execution_result: Dict[str, Any], 
...
```"""
    ...
    def build_artifacts_section(self, test_file_path: str,
                               screenshot_sections: Dict[str, str] = None) -> str:
        """
...
- 📄 **Test File:** `{test_file_path}`"""
    ...
    def build_header(self, status: str, test_file_path: str) -> str:
        ...
        return f"## {status_emoji} AutoQA Test Generation Results\n**Status:** {status} | **Generated:** `{test_file_path}` | **Time:** {timestamp}"
