...
class TestLoginFunctionality:
    ...
    def test_valid_login(self, reports_dir):
        ...
        if not result.get('success', False):
            pytest.fail(f"Login test failed: {result.get('execution_result', {}).get('error', 'Unknown error')}")
    ...
    def test_all_login_scenarios(self, reports_dir):
        ...
        for scenario, result in results.items():
            ...
            elif 'execution_result' in result and not result['execution_result'].get('success', False):
